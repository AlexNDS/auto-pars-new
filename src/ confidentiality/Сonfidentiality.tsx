...
export const Сonfidentiality = () => {

    return (
        <div className={style.сonfidentialityBlocks} id="Сonfidentiality">
            ...
            <p>
                ...
                предпринимаемые Щепиным Александром Владимировичем (далее — Оператор).
                ...
                данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://podbor-parts.ru.
                ...
                определяемому Пользователю веб-сайта https://podbor-parts.ru.
                ...
                распространения).
                2.10. Пользователь — любой посетитель веб-сайта https://podbor-parts.ru.
                ...
                электронный адрес
                Правовые основанияФедеральный закон «Об информации, информационных технологиях и о защите информации» от
                27.07.2006 N 149-ФЗ
                ...
                exist.ofis@yandex.ru с пометкой «Актуализация персональных данных».
                ...
                Оператору уведомление посредством электронной почты на электронный адрес Оператора exist.ofis@yandex.ru
                ...
                персональных данных, обратившись к Оператору с помощью электронной почты exist.ofis@yandex.ru.
